...
const gatewayConfig = {
  ...
  services: [
    ...
    },
    {
      ...
      url: process.env.PRODUCT_SERVICE_URL || 'http://localhost:5004',
      healthEndpoint: '/health',
    ...
    {
      name: 'cart-service',
      url: process.env.CART_SERVICE_URL || 'http://localhost:5002',
      healthEndpoint: '/health',
      routes: ['/api/cart'],
      timeout: 5000,
      retries: 2,
    ...
    {
      name: 'search-service',
      url: process.env.SEARCH_SERVICE_URL || 'http://localhost:5005',
      healthEndpoint: '/health',
      routes: ['/api/search'],
      timeout: 5000,
      retries: 2,
